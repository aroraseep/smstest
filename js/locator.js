$(function () {
    ...
    var dataSourceUrl = 'https://spatial.virtualearth.net/REST/v1/data/9834c85d7a7d4df585d0939eee2be3ca/Contoso-Bank-StoreLocations/FourthCoffeeShops';
    ...
    var map = new Microsoft.Maps.Map(document.getElementById('myMap'), {
        credentials: 'Ag8er8INYGoTIzucqUD_GtLibRkUZCFAykKU_onGXMnllnuVuXhPYOglKNcSyv9c',
        center: new Microsoft.Maps.Location(52.00632, -2.12714),
        zoom: 7
    });
    ...
    function findNearbyLocations(location) {
        ...
        // Have it search within a radius of 200KM and return the top 10 results.
        var request = dataSourceUrl + '?spatialFilter=nearby(' + location.latitude +
            ',' + location.longitude + ',200)&$format=json&$top=10&key=' + sessionKey;
